"use client"
import { EnvelopeIcon, ListBulletIcon } from '@heroicons/react/16/solid'
    ...
    <div className='flex flex-row'>
        <div>
            ...
            <div className='flex flex-row space-x-2 justify-center'>
                ...
                <a href='https://forms.gle/BJrE6BozVRLhZqMB9' target='_blank'><ListBulletIcon className="h-15 w-12 hover:text-gray-700"/></a>
            </div>
        </div>
    </div>
  )
